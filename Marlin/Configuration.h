...
#define STRING_CONFIG_H_AUTHOR "(RuChef, SKR-2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FBG5"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "81e32f44-b044-46fc-ae13-7a5e4f885314"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  21.2432
    #define DEFAULT_Ki   1.4276
    #define DEFAULT_Kd  79.0247
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  91.6382
  #define DEFAULT_bedKi  16.6011
  #define DEFAULT_bedKd 337.2286
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 34, 2, -1.9 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT { {  0, 25, (Z_MIN_POS + 1) } }
